...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, JsonNode> greetingConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, JsonNode> greetingKafkaListenerContainerFactory() {
