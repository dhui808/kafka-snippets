...
public class KafkaApplicationLongMessage {
    ...
    private static String readLongMessage() throws IOException, URISyntaxException {
        String data = "";

        URL is = ClassLoader.getSystemResource("RandomTextFile.txt");
        
        //update complete location of large message here
        data = new String(Files.readAllBytes(Paths.get(is.toURI())));
        return data;
    }
